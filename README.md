...
```bash
curl -fsSL -o /usr/local/bin/kick-live https://raw.githubusercontent.com/Ka-Ga-R1/kick-live/main/kick-live.sh && chmod +x /usr/local/bin/kick-live && kick-live
```
...
```bash
curl -fsSL -o /usr/local/bin/kick-live https://raw.githubusercontent.com/Ka-Ga-R1/kick-live/main/kick-live.sh && chmod +x /usr/local/bin/kick-live
```
